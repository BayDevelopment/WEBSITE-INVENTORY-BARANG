                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="pills-home">
                        <div class="p-3">
                            ...
                            <form action="<?= base_url('staff/update-profile') ?>" method="post" class="needs-validation" novalidate>
                                <?= csrf_field() ?>
                    ...
                    <div class="tab-pane fade" id="pills-keamanan">
                        <div class="p-3">
                            <?php $validation = \Config\Services::validation(); ?>
                            <form method="post" action="<?= base_url('staff/change-password') ?>" class="needs-validation" novalidate>
                                <?= csrf_field() ?>
