        ...
        <div class="col-12">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4">
                    ...
                    <form action="<?= base_url('admin/data-barang/tambah') ?>" method="post" class="needs-validation" novalidate>
                        <?= csrf_field() ?>
                        ...
                        <div class="form-floating mb-3">
                            <select id="satuan"
                                ...
                                <?php if (!empty($satuanList)): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <option value="" selected disabled>⚠️ Silakan isi data satuan terlebih dahulu</option>
                                <?php endif; ?>
                            </select>
