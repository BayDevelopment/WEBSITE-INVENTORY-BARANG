        ...
        <div class="col-12">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4">
                    ...
                    <form action="<?= base_url('admin/data-satuan/edit/' . esc($editData['id_satuan'])) ?>"
                        method="post"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text"
                                ...
                                value="<?= old('nama_satuan', esc($editData['nama_satuan'])) ?>"
                                required>
                            <label for="nama_satuan">
                                <i class="fa-solid fa-box me-2 text-primary"></i>Nama Satuan
                            </label>
                            <div class="invalid-feedback">
                                <?= $validation->getError('nama_satuan') ?: 'Nama satuan wajib diisi!' ?>
                            </div>
                        </div>
