    ...
    <div class="text-start mb-5">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                ...
                <p class="text-muted mb-2">Kelola data barang dibawah ini</p>

                <?php if (!empty($d_barang)): ?>
                    <a href="<?= base_url('admin/data-barang/tambah') ?>"
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm p-3 mb-3">
                ...
                <form method="get" action="<?= base_url('admin/data-barang') ?>" class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2 d-grid">
                        <a href="<?= base_url('admin/data-barang') ?>" class="btn btn-secondary">
            ...
            <?php if (!empty($d_barang)): ?>
                <div class="card shadow-sm">
                    <div class="table-responsive shadow-sm rounded-3 bg-white p-3">
                        <table id="tableBarang" class="table table-striped table-hover align-middle text-capitalize mb-0 nowrap" style="width: 100%;">
...
<script>
    window.confirmDeleteBarang = function(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?= base_url('admin/data-barang/hapus/') ?>" + encodeURIComponent(id);
            }
        });
    };
</script>
